...
<main class="min-h-screen bg-gray-500 pt-40 relative">
    ...
    <section class="bg-purple-400 relative py-10 lg:py-0">

        <img class="max-w-[40px] lg:max-w-[80px] 2xl:max-w-none absolute top-0 right-0" src="<?php echo image_dir('vec-top-about.png'); ?>" alt="">
        <img class="max-w-[40px] lg:max-w-[80px] 2xl:max-w-none absolute bottom-0 left-0" src="<?php echo image_dir('vec-bottom-about.png'); ?>" alt="">
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="container mx-auto py-18 lg:py-24 flex flex-col-reverse lg:flex-row flex-wrap items-center justify-start">
            <div class="lg:w-4/12 relative">
                <div class="lg:absolute rounded-2xl lg:min-w-[640px] bg-gray-450 p-6 z-2 lg:top-[50%] translate-y-[-30%] lg:translate-y-[-50%] shadow-sm shadow-purple-400/10">
            ...
            <div class="lg:w-8/12 aspect-square lg:aspect-video">
                <img class="lg:aspect-video rounded-2xl w-full object-cover" src="<?php echo image_dir('about-stock.jpg') ?>" alt="">
            </div>
        </div>
    </section>
