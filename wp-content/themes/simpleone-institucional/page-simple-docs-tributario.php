...
<main class="bg-gray-500 relative">
    ...
    <section>
        <div class="container mx-auto py-12 pb-6 lg:pb-12 flex flex-col lg:flex-row items-center gap-x-20 justify-between">
            <div>
        ...
        <div class="container mx-auto pt-20 pb-12">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-8 lg:gap-y-12">
                ...
                <div class="card-image relative order-3 lg:order-none">
                    <img class="w-full object-cover rounded-xl h-full" src="<?php echo image_dir('sistema-2.jpg'); ?>"
                        alt="">
                </div>
